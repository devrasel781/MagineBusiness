            ...
            <div class="magine-top-icon-wrapper col-12 col-sm-3 mr-auto"> 
                <div class="magine-top-icons top-left-icons">
                    ...
                    <?php if (!empty($magine_footer_icons)) { ?>
                        ...
                        ?>
                        <div class="magine-top-woo-icon"><a href="<?php echo esc_url($destination); ?>" title="<?php echo esc_attr($desc); ?>" target="<?php echo esc_attr($target); ?>"><i class="fab fa-<?php echo esc_attr($icon); ?>"></i></a></div>
                        <?php } ?>
                    <?php } ?>
                </div>
            </div>
    ...
    <nav id="magine-header-menu" class="navbar navbar-expand-lg navbar-dark <?php echo esc_attr($magine_sticky); ?>">
        <div class="container">
            ...
            wp_nav_menu([
                ...
                'container'       => 'div',
                'container_id'    => 'magine-main-menu',
                'container_class' => 'collapse navbar-collapse',
                'menu_id'         => false,
                'menu_class'      => 'navbar-nav navbar-nav-hover justify-content-center',
                'depth'           => 3,
